...
export const HearthIcon = ({ width = '24px', height = '24px', ...props }) => (
  <svg
    {...props}
    width={width}
    height={height}
...
export const GatsbyIcon = ({ width = '24px', height = '24px', ...props }) => (
  <svg
    {...props}
    width={width}
    height={height}
...
export const GithubIcon = ({ width = '24px', height = '24px', ...props }) => (
  <svg
    {...props}
    width={width}
    height={height}
...
export const TwitterIcon = ({ width = '24px', height = '24px', ...props }) => (
  <svg
    {...props}
    width={width}
    height={height}
...
export const FacebookIcon = ({ width = '24px', height = '24px', ...props }) => (
  <svg
    {...props}
    width={width}
    height={height}
...
export const LinkedinIcon = ({ width = '24px', height = '24px', ...props }) => (
  <svg
    {...props}
    width={width}
    height={height}
...
export const CodepenIcon = ({ width = '24px', height = '24px', ...props }) => (
  <svg
    {...props}
    width={width}
    height={height}
