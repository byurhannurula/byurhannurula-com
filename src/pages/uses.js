...
const UsesPage = () => (
  <Layout title="Uses">
    <Container small>
      <Title>Uses</Title>
      <Text>
        I&apos;m constantly improving and upgrading my setup, so expect changes
      ...
      <List>
        ...
        <li>
          ...
          <ExternalLink url="https://fishshell.com/">Fish shell</ExternalLink>{' '}
          and{' '}
      ...
      <List>
        <li>
          ...
          <ExternalLink url="https://brave.com/">Brave Browser</ExternalLink>{' '}
          and{' '}
        ...
        <li>
          ...
          <ExternalLink url="https://www.alfredapp.com/">Alfred</ExternalLink>{' '}
          to my workflow.
        </li>
        <li>
        ...
        <li>
          ...
          <ExternalLink url="https://www.sblack.online/">Sblack</ExternalLink>{' '}
          for messaging and{' '}
          <ExternalLink url="https://sparkmailapp.com/">Spark</ExternalLink> as
          a mail app.
        </li>
        <li>
      ...
      <List>
        <li>
          ...
          and{' '}
          <ExternalLink url="https://csspeeper.com/">CSS Pepper</ExternalLink>{' '}
      ...
      <List>
        ...
        <li>
          <ExternalLink url="https://www.namecheap.com/">
            Namecheap
          </ExternalLink>{' '}
